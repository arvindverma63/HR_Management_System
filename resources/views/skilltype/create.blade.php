                ...
                <div class="bg-white rounded-2xl shadow-xl p-4 sm:p-5 md:p-6 lg:p-8 mt-6">
                    ...
                    <form action="{{ route('skilltype.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="rate" id="percentage" value="{{ old('rate') }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-custom-blue" required>
                        </div>
