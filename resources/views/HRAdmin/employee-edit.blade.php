                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
                    ...
                    <form method="POST" action="{{ route('employee.update', ['id' => $employee->id]) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="clims_id" name="clims_id" value="{{ $employee->clims_id }}"
                                class="mt-1 w-full p-2 border rounded-lg focus:ring-2 focus:ring-custom-blue"
                            ...
                            <div>
                                ...
                                <select id="designation" name="designation"
                                    ...
                                    @foreach ($designations as $d)
                                        <option value="{{ $d->id }}"
                                            {{ old('designation', $employee->designation) == $d->id ? 'selected' : '' }}>
                                            {{ $d->name }}</option>
                                    @endforeach
                                </select>
                                @error('designation')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <textarea id="local_address" name="local_address"
                                    class="mt-1 w-full p-2 border rounded-lg focus:ring-2 focus:ring-custom-blue">{{ $employee->local_address }}</textarea>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <textarea id="permanent_address" name="permanent_address"
                                    class="mt-1 w-full p-2 border rounded-lg focus:ring-2 focus:ring-custom-blue">{{ $employee->permanent_address }}</textarea>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <textarea id="nominee_address" name="nominee_address"
                                    class="mt-1 w-full p-2 border rounded-lg focus:ring-2 focus:ring-custom-blue">{{ $employee->nominee_address }}</textarea>
                            </div>
                            <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="refer_by" name="refer_by"
                                value="{{ old('refer_by', $employee->refer_by) }}"
                                class="mt-1 w-full p-2 border rounded-lg focus:ring-2 focus:ring-custom-blue"
                        ...
                        <button type="submit"
                            class="w-full bg-custom-blue text-white py-2 rounded-lg hover:bg-custom-blue-dark transition-all">Update
                            Workman</button>
                    </form>
                </div>
            </section>
